...
## Cross-state surfacing, the buyer-facing note

> Moved here from SKILL.md under PHILOSOPHY P7. SKILL.md keeps the mandate and the trigger; the
> wording and the state-specific figures live with the rest of the fee data, which is this file.
...
## DC / VA / MD commuter-corridor sub-case
