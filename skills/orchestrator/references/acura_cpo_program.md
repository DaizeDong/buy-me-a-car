...
This file mirrors the structure of `honda_cpo_program.md` (Acura is Honda's luxury division; its CPO mechanics parallel Honda True Certified but with luxury-tier coverage and a distinct second "Used" tier).
...
|---|---|---|---|---|---|
| **Top** | **Acura Precision Certified** | <= 6 yr | < 80,000 mi | 182-point | Full luxury CPO (7yr/100k powertrain + 2yr/100k limited B2B) |
...
Per acuracertified.com/certified-preowned-benefits and KBB:

### Acura Precision Certified (top tier)

| Criterion | Threshold |
|-----------|-----------|
| Age from original in-service date | **Max 6 years** (e.g., 2026 program covers ~2020-2026 in-service vehicles) |
| Mileage | **Under 80,000 mi** at time of delivery to retail customer |
| Inspection | Must pass Acura's **182-point** certified inspection (downloadable report) |
| Dealer | Must be sold by authorized Acura dealer |
| Title / history | Clean **unbranded** title; no flood, salvage, or rebuilt branding |
...
| Mileage | **No mileage restriction** (per Acura press release) |
| Inspection | Must pass Acura's **112-point** certified inspection (downloadable report) |
| Dealer | Must be sold by authorized Acura dealer |
| Title / history | Clean unbranded title |

A 2017 Acura MDX with 95,000 mi is too old/high-mileage for Precision Certified but **does** qualify for Precision Used.
...
| **Limited (non-powertrain / B2B) warranty** | **2 years / 100,000 miles**, beginning at expiration of the New Vehicle Limited Warranty (or date of sale if NVLW already expired) |
| Deductible | $0 |
| Roadside Assistance | **2 years from purchase / 100,000 mi** (whichever first), 24/7 |
| Transferable | Yes (within warranty period) |
| Trip Interruption | Reimbursement included during warranty period |
| Concierge service | Included during warranty period |
| First scheduled maintenance | **Free** (oil change etc.), within 1 yr / 12,000 mi |
...
|-----------------|------|
| Acura Precision Certified (built-in) | Already in dealer price |
| **Acura Care VSC** (Acura's own VSC, separate purchase) | **$1,500-$3,500+** depending on model / mileage / deductible (exclusionary "best-type" coverage) |
| Third-party (Endurance, CARCHEX, Olive) | comparable luxury powertrain coverage typically $2,000-$3,000+ |
...
## What Acura CPO Does NOT Cover

- Wear items (tires, brake pads, wiper blades, batteries)
- Accident / collision damage (not warranty work)
- Cosmetic items (paint chips, interior wear, scratched alloys, glass, upholstery, trim, carpeting)
- Aftermarket-modified items (tunes, non-Acura audio, lifts)
...
## CPO vs Non-CPO Math (worked example)

For a 2023 Acura RDX A-Spec AWD 30k mi:

| Scenario | Effective Cost |
|----------|---------------|
| **Precision Certified included** in dealer sale at $34,990 | $34,990 OTD basis (CPO value embedded) |
| Non-CPO same VIN at $33,490 (-$1,500) + buy Acura Care VSC separately at ~$2,000 | $35,490 effective |
...
## Negotiating Acura CPO

If an Acura is Precision Certified-eligible but the dealer has not enrolled it:

> Could you enroll this vehicle in Acura Precision Certified as part of the sale? This adds the 7yr/100k powertrain extension, 2yr/100k limited warranty, and 2yr roadside, and is a standard Acura-authorized retailer offering for sub-80k-mi cars under 6 years from in-service.

Dealers can enroll a qualifying car for an internal cost (inspection + program enrollment). They may fold it into the deal at no separate charge, especially if you've reduced your OTD ask elsewhere.

**Phase 6 play:** When a non-CPO 2020+ RDX/MDX is priced within ~$1,000 of a Precision Certified same-trim same-mileage comp, ask the non-CPO dealer to enroll Precision Certified at their cost. Given Acura's higher repair costs, the 2yr/100k limited B2B is the strongest single give to extract.

**Watch the tier:** Some dealers advertise "certified" loosely. Confirm whether a unit is **Precision Certified** (the real luxury CPO) vs **Precision Used** (light, non-transferable). Paying Precision-Certified money for a Precision-Used car is a common overpay.

---

## For Out-of-CPO Cars (Over 10 Years, or Top-tier-ineligible)
...
|---|---|---|
| Age cap | 6 yr from in-service | 6 yr from in-service |
| Mileage cap | 80k mi | 85k mi |
| Inspection | 182-point | 150-point |
| Powertrain extension | 7 yr / 100k from in-service | 7 yr / 100k from in-service |
| Limited B2B | **2 yr / 100k** | 1 yr / 12k (standard) / 2 yr / 24k (Certified+) |
| Roadside | 2 yr / 100k | duration of CPO warranty |
| Embedded value (est.) | ~$1,800-$2,800 | $1,200-$1,800 |
| Second "Used" tier (10 yr, no mileage cap) | **Yes (Precision Used)** | No (Honda True Used is not a real CPO tier) |

Acura CPO embedded value runs HIGHER than Honda's because Acura is a luxury division with higher repair/labor costs and a longer 2yr/100k limited B2B. Budget ~$500-$1,000 MORE "CPO discount leverage" with Acura than with Honda.
